...
public class RmqMessageType {
    ...
    public static final String RMQ_MSG_STR_OUTBOUND_GET_OFFER_REQ	= "mfmp_get_offer_req";
    public static final String RMQ_MSG_STR_OUTBOUND_GET_OFFER_RES	= "mfmp_get_offer_res";
    public static final String RMQ_MSG_STR_OUTBOUND_SET_ANSWER_REQ	= "mfmp_set_answer_req";
    public static final String RMQ_MSG_STR_OUTBOUND_SET_ANSWER_RES	= "mfmp_set_answer_res";
